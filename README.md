...
Automated builds of the image are available on [Dockerhub](https://hub.docker.com/r/timjdfletcher/squid) and is the recommended method of installation.

> **Note**: Builds are also available on [Quay.io](https://quay.io/repository/timjdfletcher/squid)

```bash
docker pull timjdfletcher/squid:4.13-1
```

Alternatively you can build the image yourself.

```bash
docker build -t timjdfletcher/squid github.com/timjdfletcher/docker-squid
```
